...
public class ClientPlanResultDTO {
    private String name;
    private String uri;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClientPlanResultDTO)) {
            return false;
        }
        ClientPlanResultDTO other = (ClientPlanResultDTO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ClientPlanResultDTO;
    }
    ...
    public String toString() {
        return "ClientPlanResultDTO(name=" + this.getName() + ", uri=" + this.getUri() + ", description=" + this.getDescription() + ", status=" + this.getStatus() + ", updateTime=" + this.getUpdateTime() + ", createTime=" + this.getCreateTime() + ")";
    }
}
