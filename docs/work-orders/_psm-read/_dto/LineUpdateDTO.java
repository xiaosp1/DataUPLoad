...
public class LineUpdateDTO {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LineUpdateDTO)) {
            return false;
        }
        LineUpdateDTO other = (LineUpdateDTO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof LineUpdateDTO;
    }
    ...
    public String toString() {
        return "LineUpdateDTO(id=" + this.getId() + ", name=" + this.getName() + ", lineNo=" + this.getLineNo() + ", faceNo=" + this.getFaceNo() + ", color=" + this.getColor() + ", clientNo=" + this.getClientNo() + ")";
    }
}
