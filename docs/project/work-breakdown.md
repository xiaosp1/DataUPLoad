...
| A2 | 数据库 schema + 迁移 | **w-a2-db-schema** | 🟢 跑着（intco.db 工程已建）| 老板批 |
| A3 | DTO 定义 + HTTP 客户端 | TBD | 🟡 待派工 | A1+A2 完成 |
| A4 | 视觉数据接收端 | TBD | 🟡 待派工 | A1+A2+A3 完成 |
| A5 | 字典 + 缺陷查询 | TBD | 🟡 待派工 | A1+A2+A3 完成 |
| A6 | 英科登录 + Ticket 管理 | TBD | 🟡 待派工 | A3 完成 |
| A7 | 报警推送 | TBD | 🟡 待派工 | A4+A6 完成 |
| B1 | Web 大屏 | TBD | 🟡 待派工 | A1 完成 |
